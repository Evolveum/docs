...
If you use xref for linking a reference page, please do not specify the version.
By default, the xref macro automatically adds the current version to the link.
If you want to link a specific version of a page, please use the slightly modified macro xrefv:.
