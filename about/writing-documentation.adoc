...
[WARNING]
====
Many macros, such as the `btn` macro, don't render unless you add the `:experimental:` flag to the page header. Not to be confused with the xref:#experimental[:page-experimental: flag].
====
