...
For a detailed explanation, see https://wiki.evolveum.com/display/midPoint/Community+Guidelines[midPoint community guidelines].
...
See also the details of https://wiki.evolveum.com/display/midPoint/Release+Process[midPoint versioning and release process].

* Basic procedure how to https://wiki.evolveum.com/display/midPoint/Building+MidPoint+From+Source+Code[build a source code].
...
* https://wiki.evolveum.com/display/midPoint/Troubleshooting[Troubleshooting section] in midPoint wiki.
...
and https://wiki.evolveum.com/display/midPoint/Troubleshooting[wiki]).
...
Please create a https://wiki.evolveum.com/display/midPoint/Creating+a+Bug+Report[bug report].
...
Please see https://wiki.evolveum.com/display/midPoint/Support+Guidelines[support guidelines] for the details.
...
There is a https://wiki.evolveum.com/display/midPoint/Creating+a+Bug+Report[bug reporting guide] to check that you have included everything in the report.
...
** Mid-term midPoint development plan is documented in https://wiki.evolveum.com/display/midPoint/Roadmap[midPoint Roadmap].
...
See https://wiki.evolveum.com/display/midPoint/Long-Term+Support[Long-Term Support] page for the details.
...
* link:/book/[MidPoint book] - this is a *must read* for all midPoint engineers.

* link:/iam/[Introduction to Identity and Access Management]

* link:/community/sites/[List of community sites (Evolveum public tools)]

* https://wiki.evolveum.com/display/midPoint/Participation[Tips for participation in midPoint community]
