...
Link to environment: https://han-demo.evolveum.com/[https://han-demo.evolveum.com/] +
{nbsp} +
...
. Download this han-demo_recovery-file_1.1.xml[Recovery file (1)] https://docs.evolveum.com/community/misc/han-demo_recovery-file_1.1.xml[Recovery file (2),window=_blank]
