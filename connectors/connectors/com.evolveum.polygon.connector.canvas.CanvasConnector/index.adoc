...
| 1.1.3
| Evolveum
| https://nexus.evolveum.com/nexus/repository/releases/com/evolveum/polygon/connector-canvas-lms/1.1.3/connector-canvas-lms-1.1.3.jar[download jar]
| https://github.com/Evolveum/connector-canvas-lms/tree/v1.1.3[Evolveum git repository (v1.1.3)]
| Mar 26, 2026
| Stable version
| No
| Added support for HTTP proxy via -D options such as `-Dhttp.proxyHost/Port`, etc.
See https://docs.oracle.com/javase/8/docs/technotes/guides/net/proxies.html[Java Networking and Proxies] documentation.
