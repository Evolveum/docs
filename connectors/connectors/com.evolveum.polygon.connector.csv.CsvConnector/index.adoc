...
=== Known Issue
The csv connector can't initialize if the input file xref:https://support.evolveum.com/projects/midpoint/work_packages/9498[contains UTF-8 BOM characters].
To avoid the issue, remove the UTF-8 BOM characters from the csv files.
