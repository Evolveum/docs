...
Sample resource XML can be found link:https://github.com/Evolveum/midpoint-samples/blob/master/samples/resources/googleapps/googleapps-resource.xml[here].
...
. Open JSON file and make note of following properties: `"client_id":"XXXX434004-XXXu8jrm1iqp3clirelba480qXXX.apps.googleusercontent.com"` and `"client_secret":"48zv5mfYZZZZw3QTcb8RBXXX"` +
