...
The only problem here is that the connector does now know about the Auxiliary Object Classes, and is not capable of requesting the proper non-structural objectClass attributes.

The solution for this is to specify the Auxiliary Object Classes as values of the `auxiliaryObjectClasses` configuration property.
Each value of this property is a string following a specific formatting convention.
...
What the value `inetOrgPerson:posixAccount` represents is:
