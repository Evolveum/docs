...
residing in the subject object class is being evaluated each time. The memberOf and referential integrity module
has to be enabled when native associations configuration is set up. Also, LiveSync is not capable
