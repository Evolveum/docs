...
[NOTE]
====
Active Directory 2012 including any of its variants (2012R2) and Active Directory 2012 including any of its variants (2012R2) are no longer supported, as they are not covered by regular (mainstream) support from Microsoft.
