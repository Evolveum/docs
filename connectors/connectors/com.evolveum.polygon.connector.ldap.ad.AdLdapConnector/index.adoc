...
* Active Directory Domain Services (AD DS), Windows Server 2025
...
* Minimal xref:/midpoint/reference/resources/resource-configuration/schema-handling/attributes/fetch-strategy/[fetch strategy] does not work reliably.
...
| 3.7.5
| Evolveum
| https://nexus.evolveum.com/nexus/repository/releases/com/evolveum/polygon/connector-ldap/3.7.5/connector-ldap-3.7.5.jar[download jar]
| link:https://github.com/Evolveum/connector-ldap/tree/v3.7.5[GitHub]
| 21th May 2026
| 1.5.2.0
| 4.8.12
| Bumped mina-core to 2.2.7.

| 3.7.6
| Evolveum
| https://nexus.evolveum.com/nexus/repository/releases/com/evolveum/polygon/connector-ldap/3.7.6/connector-ldap-3.7.6.jar[download jar]
| link:https://github.com/Evolveum/connector-ldap/tree/v3.7.6[GitHub]
| 14th July 2026
| 1.5.2.0
| 4.8.13
| Bumped mina-core to 2.2.9.
...
| 3.9.2
| Evolveum
| https://nexus.evolveum.com/nexus/repository/releases/com/evolveum/polygon/connector-ldap/3.9.2/connector-ldap-3.9.2.jar[download jar]
| link:https://github.com/Evolveum/connector-ldap/tree/v3.9.2[GitHub]
| 25th November 2025
| 1.5.3.0-M3
| 4.9.6
| Bumped mina-core to 2.2.6.

| 3.9.3
| Evolveum
| https://nexus.evolveum.com/nexus/repository/releases/com/evolveum/polygon/connector-ldap/3.9.3/connector-ldap-3.9.3.jar[download jar]
| link:https://github.com/Evolveum/connector-ldap/tree/v3.9.3[GitHub]
| 21th May 2026
| 1.5.3.0-M3
| 4.9.7
| Bumped mina-core to 2.2.7. Fixed TLS1.2 connection issues.

| 3.9.4
| Evolveum
| https://nexus.evolveum.com/nexus/repository/releases/com/evolveum/polygon/connector-ldap/3.9.4/connector-ldap-3.9.4.jar[download jar]
| link:https://github.com/Evolveum/connector-ldap/tree/v3.9.4[GitHub]
| 14th July 2026
| 1.5.3.0-M3
| 4.9.8
| Bumped mina-core to 2.2.9.
