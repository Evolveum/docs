...
Also see xref:/connectors/connid/1.x/connector-development-guide/#discovery-support[Discovery Support].
...
=== Latency of Create Operations and Rate Limits [review]
...
In general the connector should communicate with the same node or some sort of session stickines should be used in case of multiple nodes of an application cluster (load balancing).
