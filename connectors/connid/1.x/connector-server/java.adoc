...
[NOTE]
====
In case you are working with containers ( e.g. docker, kubernetes... ) there is available dockerfile to build the image on link:https://github.com/Evolveum/midpoint-dockerblob/master/Dockerfile-cs[gitHub].
