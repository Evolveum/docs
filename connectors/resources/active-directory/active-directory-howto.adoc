...
If you have configured SSL on the connector server you should also install the appropriate CA certificate to a midPoint xref:/midpoint/reference/security/crypto/keystore-configuration/[keystore] as described on wiki:Connector+Server[Connector Server] page.
