...
This example will covert the situation you have your own CA for the test environment.
...
spc ad01.p12 192.168.122.161:C:/Users/Administrator/Desktop/certificate.pfx
----
