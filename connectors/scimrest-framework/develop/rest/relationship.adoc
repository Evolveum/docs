...
:page-nav-title: Relationship
:page-display-order: 1340
:page-upkeep-status: orange
:page-moved-from: /connectors/scimrest-framework/develop/50-relationship/
:page-description: How to define and implement relationships between object classes in a SCIMREST connector using the relationship builder and virtual reference attributes.
:page-keywords: object relationship, reference attribute, ConnId association, relationship builder, virtual attribute

How to define and implement relationships between object classes in a SCIMREST connector using the relationship builder and virtual reference attributes.
