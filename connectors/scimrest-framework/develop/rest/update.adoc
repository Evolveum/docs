...
:page-description: How to implement update operations in a SCIMREST connector using PATCH or PUT, including multi-endpoint scenarios and attribute-specific endpoint routing.
:page-keywords: update operation, PATCH endpoint, PUT endpoint, Groovy script, connector update
