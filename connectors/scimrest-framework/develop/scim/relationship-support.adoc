...
:page-toc: top
:page-description: SCIM 2.0 relationship support in the SCIMREST framework: automatic group/user relationships, custom relationship definitions, and resolver configuration.
