...
:page-toc: top
:page-description: How to configure SCIM 2.0 PUT and PATCH update operations in a SCIMREST connector, including attribute limitations and per-request operation constraints.
:page-keywords: SCIM update operation, PATCH operation, PUT operation, attribute limitations, SCIM connector
