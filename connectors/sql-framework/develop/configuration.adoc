...
// TODO: Any reason why articles in the develop section are orange instead of green even though they're new as the others one level up?
//       Please add an upkeep status to the develop/index article accordingly as well.
:page-toc: top
:page-since: 4.11
...
// TODO: What is the intended meaning of the logical OR here?
//       Is it that scanTables AND scanViews have been derived from the respective parts of the getAutoDiscoverSchema() method?
