...
// TODO: I don't see "DDL" written out anywhere - is it universally understood?
...
The SQL Framework does not bundle JDBC drivers — the driver for your database must be part of the connector bundle (see xref:custom-connector/#packaging-the-bundle[packaging]).
The driver class is resolved automatically from the `jdbcUrl` scheme (see xref:configuration/#driver-resolution[driver resolution]).
