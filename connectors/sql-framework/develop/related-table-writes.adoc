...
This document is part of the SQL connector tutorial. See the xref:../[section root] for other topics.
...
* Object classes without a `__UID__` mapping cannot participate in writes at all (see xref:schema-discovery/[UID detection]).
