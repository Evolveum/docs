...
* *constraint-based* — columns that have an actual foreign key constraint to a discovered table, and
...
Depending on what the foreign key columns contribute to the child table's primary key, the relationship is classified:
