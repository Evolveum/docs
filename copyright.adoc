...
You can save the documentation for off-line use.
...
E.g., you can convert the documents to make them readable for visually-impaired people.
...
While we make reasonable effort to maintain the quality of the documentation, we are people too.
...
If you bet your fortune on the information in the documentation, it is your responsibility to make sure the information is correct, complete, and up to date.
...
NOTE: This license applies to the _documentation_ only.
You are not allowed to use Evolveum sales, marketing, and any other materials.
You are not allowed to use our trademarks.
You need a special license for this.
Such a license is usually part of Evolveum partner agreement.
