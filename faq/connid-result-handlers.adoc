...
Those "result handlers" are an artifact of an https://wiki.evolveum.com/display/midPoint/ICF+Issues[original Identity Connector Framework over-engineering].
