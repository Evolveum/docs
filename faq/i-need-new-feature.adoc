...
:page-description: This article describes how to request or contribute a new midPoint feature—develop it yourself, submit an idea, get a subscription, or sponsor development on the roadmap.
:page-keywords: new feature request, feature development, Evolveum subscription, platform subscription, feature sponsorship, contribute to midPoint

== I need to do something that cannot be done in stock midPoint right now. What should I do?

There are several options for you.
But before we get to that, we would like to describe the situation of the midPoint project so that you can better understand your options and our motivations.
...
* Partners that help promoting midPoint in business or academic environments by independently organizing presentations, marketing activities, preparing papers, writing blogs, etc.
