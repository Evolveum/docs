...
link:/iam/identity-provisioning/[Identity provisioning] is a technology originally designed for enterprise account synchronization and management of identity-related business processes.
...
This efficiently avoids link:/iam/role-explosion/[role explosion] problem.
...
* link:/iam/best-practice/[Best Practice]

* link:/iam/antipatterns/[Antipatterns]