...
The things start to go the link:/iam/antipatterns/diy-idm/[DIY way].
...
How do we get the data from these sources to the directory server? Well, there is always the link:/iam/antipatterns/diy-idm/[DIY way].
...
The practical solution usually has three components: link:/iam/best-practice/management-directory-access/[directory service, identity management and access management].
...
* link:/iam/antipatterns/diy-idm/[DIY IDM]