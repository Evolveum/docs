...
Make sure that the xref:/iam/idm-consistency/[consistency mechanism] of your IDM system is designed to handle that.
...
* When choosing or implementing a solution make sure you consider a xref:/iam/idm-consistency/[consistency mechanism]. It may seem as an implementation detail from the distance, but this little detail may ruin entire project.
