...
When basic incompatibilities are handled there is another obstacle: xref:/iam/role-explosion/[role explosion]. The number of roles required to define all the necessary permission combinations grows rapidly.
...
xref:/iam/role-explosion/[Role explosion] is a common problem and definitely a dead end for an RBAC program.
