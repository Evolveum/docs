...
TODO: inventory of identity resources, connectors

* *Communication with source/target systems*
TODO: CRUD operations
TODO: Protocol adaptation
TODO: connectors, schema, data type conversion
TODO: provisioning scripts

* *Fulfilment failure handling*
TODO: error detection, interpretation, operation retries

* *Identity resource capability adaptation*
TODO: simulation of missing capabilities

* *Identity state tracking*
TODO: Account attribute caching, cache maintenance
TODO: Account status tracking (e.g. dead accounts)

* *Management of manual operations*
TODO: manual fulfillment, connection to ITSM
...
// TODO: identity resources, connection to target/source systems, schema discovery, ...
