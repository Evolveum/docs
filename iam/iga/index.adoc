...
_Direct_ connection to applications and data stores is almost always essential for IGA platform to function properly (see xref:../myts/indirect-access.adoc[indirect access antipattern] for more details).
