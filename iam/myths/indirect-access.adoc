...
Instead of dealing with all the xref:../ldap-survival-guide[messy details of directory service structure] we can just make an SQL insert, and the good old script does all the work.
