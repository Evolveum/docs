...
The obvious starting point are popular groups: groups that have large number of users as members.
These are prime candidates for building first business roles.
...
// TODO: this is difficult to do by hand => role mining, AI, clustering, pattern recognition

// TODO: Bottom-up approach is usually more practical in real-world situations.
// TODO: it is feasible, especially with mining
// TODO: bottom-up is mapping real practical policy, not formal rubber-stamped policy

// TODO: problems of bottom-up: it is approximate, it legalizes status quo (e.g. over-provisioning)
// TODO: it needs human supervision and validation, natural intelligence to supplement AI, it cannot be done blindly.
// TODO: bottom-up: business first, security second.
// TODO: bottom-up needs to be followed by consolidation (clean-up)

// TODO: top-down under-provisioning disturbs business, while bottom-up over-provisioning maintains business

// TODO: recommendation: use top-down approach for the "whales", small number of high-impact roles.
// use bottom-up approach to mine mid-size roles
// forget about very small business roles, use application roles and risk-based certification

// TODO: this may be different for CIAM or similar cases where policies are simple and *known*.


// TODO: long-term goal IT-business alignment: orgstruct-roles-entitlements-applications
// TODO: data quality feedback to HR, orgstruct, business units, etc.
