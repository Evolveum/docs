...
_Birthright permissions_ that belong to employees should not be by a role, it should be assigned by the same mechanism that decided that a user should be an employee.
...
`Marketing department` is not a role, it is an organizational unit.
