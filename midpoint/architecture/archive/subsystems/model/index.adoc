...
It is designed (see xref:/midpoint/reference/roles-policies/rbac/[Advanced Hybrid RBAC]) and the implementation awaits prioritization in the wiki:Roadmap[Roadmap].
