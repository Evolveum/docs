...
:page-archived: true
:page-outdated: true:page-wiki-name: Synchronization Implementation
...
See the xref:/midpoint/reference/expressions/introduction/[Mappings and Expressions] page for an introduction to this topic.
