...
Schema processor from the wiki:Infrastructure+Subsystem[Infrastructure Subsystem] is used to handle the dynamic xref:/midpoint/reference/resources/resource-schema/[Resource Schema]. It is used by almost all provisioning layers.
