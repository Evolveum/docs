...
flowchart TD
    ...
    %%   • User – dark‑blue border on white background (high contrast)
    %%   • Role – light‑blue fill with dark‑blue text
    %%   • Account – greenish fill (middle‑blue) with white text
    %%   • Entitlement – orange fill with white text
    classDef user   fill:#ffffff,stroke:#14205F,color:#14205F;
    classDef role   fill:#44ACDB,stroke:#14205F,color:#ffffff;
    classDef acct   fill:#265DA6,stroke:#265DA6,color:#ffffff;
    classDef ent    fill:#FF9B05,stroke:#FF9B05,color:#ffffff;
