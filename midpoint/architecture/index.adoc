...
This "model" takes care of representing the users, accounts, roles, policies and controlling their _behavior_.
In MidPoint this is implemented in IDM Model Subsystem, which is a true heart and brain of the system.
