...
This includes xref:/midpoint/get-started/install/[installation documentation], xref:/midpoint/reference/[reference documentation], xref:/midpoint/architecture/[architectural documentation], xref:/midpoint/devel/[developer documentation], even a publicly accessible xref:/book/[book] about use of midPoint.
