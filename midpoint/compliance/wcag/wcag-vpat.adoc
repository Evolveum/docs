...
idPoint is an identity governance and administration (IGA) platform used to manage digital identities, their attributes and access rights across connected systems.
