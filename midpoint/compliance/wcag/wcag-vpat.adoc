...
This report was last updated on 2026-03-17.

== Product

*midPoint, release 4.10.2*
...
midPoint has undergone accessibility evaluation using a combination of automated tools and manual testing techniques.
...
This report reflects outstanding issues found by technical review based on the level A and AA criteria of the
