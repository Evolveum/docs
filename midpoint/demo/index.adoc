...
The live demo environment is deployed on a kubernetes cluster with two nodes.
...
HR is deployed in Tomcat web container together with address book system.
...
link:https://github.com/Evolveum/midpoint-kubernetes/tree/main/midpoint-live-demo/base/midpoint-renaissance-demo-config[https://github.com/Evolveum/midpoint-kubernetes/tree/main/midpoint-live-demo/base/midpoint-renaissance-demo-config]
...
Check that by opening user details and switching to _All direct/indirect assignments_ in _Assignments_ tab.
...
. Navigate to _Password_ tab in user details.
