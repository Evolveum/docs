...
For simplicity, notifications are stored on disk instead of being sent by e-mail.
The same Message Template can be used with other notification transports, such as e-mail or SMS.
