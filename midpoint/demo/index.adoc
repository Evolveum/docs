...
.. The types of objects you can select from are displayed in the new window. See that you can also define assignment relation (Default or other) at this point. Click on the tile _Organizational unit (Default)_.
