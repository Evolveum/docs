...
Which metadata attributes should be included in WWW report (aka: xref:/midpoint/methodology/iga/reporting/www-report/[report Who Has Access Where and Why]).
...
|createTaskRef |Yes? |Which tash did the assignment| This is technical information, so removal may be considered. If used, the name of the task should be displayed.
