...
The supported way of constructing search filters and object queries is now QueryBuilder API (described under the name of Fluent API xref:/midpoint/reference/concepts/query/query-api/[in this document]).
