...
*Primary source:* link:/midpoint/devel/testing/test-scenarios/[Test Scenarios].
...
* Kate is creating automated Selenium-based tests: link:/midpoint/devel/testing/gui/[GUI Testing]
