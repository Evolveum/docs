...
| Account Tests
| SelenideOscar
| #1, #2, #3 -OK, but when we run twice in empty MP DB test ResourceUserAccountTests, it occured bug:MID-2731[] #4, #5, #6 - OK, #7 on CSVFile after run CsvAccountTests
...
| Oscar
| #1, #2, #3, #4 - OK, #5 [.line-through]#bug:MID-2667[]#
...
| Oscar
| #1, #2, #3, #4, #5 - OK, #6: bug:MID-2666[], #7 OK, #8 *same result in (2) as in (1)*, #9, #10 ignored (TODO: description to test), #11 - OK, #1 - OK
...
| Reports
| Oscar
| #1 - bug:MID-2709[], bug:MID-2710[] #2, #3 - OK


| Workflow Features
| Oscar
| #1 [.line-through]#bug:MID-2711[]# , #2, #3, #4, #5 - OK, #8, #9 - OK


| Notifications
| Oscar
| #1, #2, #3 - OK #4 bug:MID-2687[], #5, #6, #7 - OK
...
| Oscar
| always hidden menu item, see [.line-through]#bug:MID-2656[]#
