...
* `Understaffed`: Pre-defined mark for "understaffed", "staff shortage" or "vacancies", such as no manager for project, less than two members of critical team, etc.
...
Can be used in pre-configured dashboard.
As opposed to regular `Understaffed` mark, this can be used in dashboards with higher severity, as security-related shortage is likely to pose high risk.
(ISO 27001 5.2)
