...
* Find all objects with policy rules? Or is PolicyType enough?
...
* How to make "SoD policy" report? We need more specific use-cases (look for roles with policies? look for users influenced by policies?)
