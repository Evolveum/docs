...
* Ability to mark object by arbitrary object mark in GUI.

* Show effective marks in object lists and object details (GUI).

* Show effective assignment marks in list of all assignments (GUI).
