...
** [red]*(!!!)* Maximum password length (ENISA-baseline)

** [red]*(!!!)* Support for password at least 128 characters (ENISA-baseline)

** [red]*(!!!)* minimum and maximum usage period (ENISA-baseline)

** [red]*(!!!)* maximum number of password changes per time (e.g. per day) (ENISA-baseline)
...
* [red]*(!!!)* Service accounts shall not be usable for interactive logon - check default configuration (ENISA-baseline)
