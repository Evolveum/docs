...
** resolve bug #8579 - wrong report preview for IGA report

** Update who has access to what and why report.
Extend with approver info. (how?)

** list all privileged roles (roles that provide privileged access)

** list of users who have privileged access

* Methodology and examples:

** additional approval level for high-classification applications

** methodology how to use policies and object marks (policies define rules - they act, object marks show status)

*** manual setup -> manual cleanup

*** automatic setup, manual cleanup, automatic cleanup at the end

*** automatic setup, automatic cleanup
...
*** roles without approver (if possible)

*** unassigned roles

*** most complex business roles (over <XY> inducements)

*** empty/weak business roles (with zero or one app role induced)
...
*** Users with overassigned licenses (policy XY)
