...
* bug:9869[] Policy rules minAssignees/maxAssignees are not triggering
* bug:9925[] Marks not visible in GUI

Not critical, yet very painful:

* bug:9929[] Default marks for policy rules does not work
* bug:9914[] Certification campaign definition: PolicyType cannot be selected
...
* Documentation generator/visualization: generate "Procedures for managing identities" for auditors out of midPoint configuration.
...
* Re-approval / re-certification of policy rule exceptions.
...
* Zero trust concept and non-human identities (NHI).
(ISO 27001 5.15)

* Explain _object governance_ concept, especiaply for role owner/approver and application/asset owner.
(ISO 27001 5.15)
