...
* bug:11653[] Revisit cel-java implementation
* bug:10433[] Handling of "enforce" policy rules with pre-existing violation

* bug:11654[] Better default configuration: Design discussions regarding archetypes, org roots and rules (initial objects)

* bug:11655[] Password management: to pass ISO27001 requirements
...
* bug:11656[] Detect extra (unknown) members in groups.
This is critical especially for groups that provide privileged access.
(ISO27001 8.2)

* bug:11657[] Improve `midpoint.getManagersOidsExceptUser(object)` to prefer archetyped orgs.
