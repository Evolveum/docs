...
* [WIP] bug:10061[] Safe expression language - critical for security (e.g. safe demo)
* [PLANNED for 4.12] bug:11653[] Revisit cel-java implementation
* [PLANNED for 4.12] bug:10433[] Handling of "enforce" policy rules with pre-existing violation

* [PLANNED for 4.12] bug:11654[] Better default configuration: Design discussions regarding archetypes, org roots and rules (initial objects)

* [PLANNED for 4.11] bug:11655[] Password management: to pass ISO27001 requirements

Not blockers, yet very painful and/or limiting:


* [PLANNED for 4.12] bug:9929[] Default marks for policy rules does not work: marks need to be always specified explicitly - which is more work, but also potential problem for upgrade
* [PLANNED for 4.12] bug:9951[] Default approval rules do not make sense anymore: we cannot add any approval-related applicable policies to initial objects
* [PLANNED for 4.12] bug:10432[] index policy rules

=== Important

What we really need to address ASAP:

* [PLANNED for 4.12] bug:10002[] archetypes and GUI - needed for basic management of birthright
* [PLANNED for 4.12] bug:10429[] minAssignee/maxAssignee: active users only
* [PLANNED for 4.11] bug:10764[] classification icon

* [PLANNED for 4.12] bug:11656[] Detect extra (unknown) members in groups.
This is critical especially for groups that provide privileged access.
(ISO27001 8.2)

* [PLANNED for 4.12] bug:11657[] Improve `midpoint.getManagersOidsExceptUser(object)` to prefer archetyped orgs.
Otherwise, the org-based expressions (e.g. approvers) does not work properly with multiple orgstructs.

Good to have ASAP:

* [PLANNED for 4.12] bug:10431[] Transitional policy rules not removing marks
...
** [PLANNED for 4.12] min/max assignees: considering active users in orgs
(ISO27001 5.36)
bug:10430[]
...
* [RESOLVED] `Privileged` classification for (application) roles (not entitlements, yet).
Show that in GUI, at least in object details.
Allow to search users/roles that have this classification.
...
* [PLANNED for 4.12] Index/search all objects that have policy rule (specific constraint, markRef and action report/enforcement)
(ISO 27001 5.3, 5.36)
bug:10432[]
...
* [PLANNED for 4.12] minAssignee/maxAssignee: ability to require _active_ assignees, not just any assignees.
bug:10429[]
