...
However, even if your server can handle big groups, you still have to be careful in your application when working with groups.
...
Working with LDAP groups is like trying to cross a minefield.
