...
does not have easy mapping to protocol buffers schema (e.g. missing persistent item identifiers).
...
Google cel-java implementation seems to be a better fit for us, although it still leaves much to be desired.
