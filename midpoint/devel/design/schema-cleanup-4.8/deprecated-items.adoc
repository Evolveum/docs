...
Second, the profiling interval should removed with it; and it was not deprecated until now.

Postponed to 5.0 by https://github.com/Evolveum/midpoint/commit/bb3a264f[bb3a264f].
| N/A
| Pavol
|
| Before or after upgrade
