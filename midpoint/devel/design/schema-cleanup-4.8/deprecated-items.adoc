...
|
| Before upgrade
| Automatic, if it is implemented.
| Critical
...
Still needed, so I have un-deprecated it.
| Pavol
|
| N/A
| N/A
...
|
| Before upgrade
| If the automatic migration is implemented, then "automatic", otherwise "manual".
...
| 4.8
| Not used anymore. Legacy approvers specification were removed back in 4.0.
