...
| xsd:long
| // planned removal
| Currently, 0 - we will keep it as is. // priority
...
| tns:LensContextType
| (removed in 4.8) // planned removal
| // priority
...
| (removed in 4.8) // planned removal
| 0 (nothing more is needed) // priority
...
| xsd:string
| // planned removal
| 0 (not deprecated anymore) // priority
...
| (removed in 4.8) // planned removal
| 2 (experimental feature) // priority
| Removed.
