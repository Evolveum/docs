...
==== Updating the Identity Data: An Alternative

There is an alternative to the agreed-upon structure that looks like this:

image::identity-variants-alternative.drawio.png[Identity Variants, An Alternative]

#TODO discuss and describe#
