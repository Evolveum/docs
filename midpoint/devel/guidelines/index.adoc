...
Full recommendation regarding interface definition can be found here: link:http://www.nlight.eu/documents/interface-definition.pdf[http://www.nlight.eu/documents/interface-definition.pdf]
...
* wiki:Development+Documentation[Development Documentation]
