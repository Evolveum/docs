...
For this purpose, the JAVA_OPTS variable or *MP_SET_* variables can be used (see xref:/midpoint/get-started/install/bare-installation/midpoint-sh/[Start script]).
...
This example utilizes the processing of the MP_SET_* environment variables in the xref:/midpoint/get-started/install/bare-installation/midpoint-sh/[Start script].
...
For details, see xref:/midpoint/get-started/install/bare-installation/midpoint-sh/[Start script].
