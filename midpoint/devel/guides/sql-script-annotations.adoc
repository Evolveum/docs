...
Long text annotations can use a block comment with continuation lines. The generator normalizes the lines into one paragraph in the generated AsciiDoc.
...
Multi-line continuation is supported for `@description`, `@change`, and `@regionDescription`.
