...
image:role-req-begin-to-end.png[Access request]
...
The chapters below describes the process in high level. Details of the access request process are xref:role-request-details.adoc[here].
...
// TODO: Sem obrazok requestu, ktory bol implementovany - automaticka implementation a manualna implementacia.
