...
// TODO linka - pridat linku na popis ako vyzera aplikacia - ze to je service nejakeho archetypu.
...
Scenario::
// Sem popis, ze chcem zacat manazovat pristup do aplikacneho resourcu

//TODO: sem linku na popis konceptu aplikacneho resourcu - na co sluzi a ako funguje.


Actors::
//to iste ako pri aplikacii


Motivation::
// Sem kratky popis konceptu aplikacneho resourcu - ze je to parametricky access -nechcem vsak riesit novu aplikaciu (mozno ani nie je v inventory)
