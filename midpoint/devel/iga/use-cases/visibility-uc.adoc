...
Examples for displaying the content and functionality of the roles to business users can be found in definition of xref:../iga-and-access/objects-and-midpoint/index.adoc#_application_role[application role] and xref:../iga-and-access/objects-and-midpoint/index.adoc#_business_role[business role].
