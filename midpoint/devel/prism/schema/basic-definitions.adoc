...
Each object has its unique identifier called simple _object identifier_ or link:/midpoint/devel/prism/concepts/object-identifier/[OID] for short.
...
link:/midpoint/projects/midprivacy/phases/01-data-provenance-prototype/processing/model/comparing-values/index.adoc[notes about comparing values].
...
See also further notes in link:/midpoint/devel/prism/concepts/deltas/#object-modifyadd-delta[Prism Deltas, ADD modification].
