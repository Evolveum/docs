...
We need to resolve issue listed already in xref:/midpoint/reference/interfaces/rest/operations/examples/demonstration-or-workaround/approvals-via-rest-howto/index.adoc[Approvals via REST howto].
See: bug:MID-6067[]
