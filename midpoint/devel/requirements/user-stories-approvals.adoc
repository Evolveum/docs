...
See xref:user-stories-certifications.adoc#_certification_triggered_by_business_users[Certification triggered by business user] in User Stories - Certifications for more details about how to handle such certifications.
