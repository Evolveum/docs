...
*Type* +
Name object type. Schema context annotation for type parameter need just title of object type ** with namespace **.
...
*Path* +
Name path to object type. Schema context annotation for type parameter need just title of object type ** with namespace **.
