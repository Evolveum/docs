...
====
Some functionality of case management is also integrated with xref:/midpoint/reference/certification/[access certification] mechanism.
...
* xref:/midpoint/reference/certification/[Access Certification]