...
This makes ideal condition for organizational structure to support use-cases such as xref:/midpoint/reference/admin-gui/role-catalog/[role catalog]. And the story does not end here.
