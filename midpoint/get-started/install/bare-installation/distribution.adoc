...
:page-moved-from: /midpoint/install/bare-installation/distribution/, /midpoint/install/distribution/
...
If you only want to try midPoint, see xref:/midpoint/get-started/quick-start/[Quickstart guide].

There are also alternative installation methods, such as xref:/midpoint/get-started/install/containers/[Containers] or installing from a xref:/midpoint/get-started/install/bare-installation/source/[building from the source code].
...
* Make sure the xref:/midpoint/get-started/install/system-requirements/[System Requirements] are met.
...
include::java-requirements.adoc[]
...
* Linux: xref:/midpoint/get-started/install/bare-installation/systemd/[Running midPoint with systemd]

* Windows: xref:/midpoint/get-started/install/bare-installation/windows-service/[Installing midPoint as a Windows Service]
