...
:page-moved-from: /midpoint/install/bare-installation/systemd/, /midpoint/install/systemd/
...
If you want to generate the `systemd` service customized to your environment, you can use the following feature of xref:/midpoint/get-started/install/bare-installation/midpoint-sh/#generate[midpoint.sh]:
...
* xref:/midpoint/get-started/install/[Installation Guides]
