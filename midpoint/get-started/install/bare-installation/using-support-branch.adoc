= Support Branches
:page-moved-from: /midpoint/install/bare-installation/using-support-branch/, /midpoint/install/using-support-branch/
...
Follow the instructions in xref:/midpoint/get-started/install/bare-installation/source/[Installing midPoint Development Snapshot - Source Code].
