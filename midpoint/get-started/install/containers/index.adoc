...
:page-moved-from: /midpoint/install/containers/, /midpoint/install/docker/alpine-based-docker-image/, /midpoint/install/docker/book-demo/, /midpoint/install/docker/dockerized-midpoint/, /midpoint/install/docker/, /midpoint/install/docker/native-demo/
...
If this is the first time you are installing midPoint, see xref:/midpoint/get-started/quick-start/[].
...
This is supported out of the box if you use our xref:/midpoint/get-started/install/containers/docker/[Docker Compose].
