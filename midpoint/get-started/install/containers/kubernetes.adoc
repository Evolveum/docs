= Vanilla Kubernetes
:page-moved-from: /midpoint/install/containers/kubernetes/, /midpoint/install/kubernetes/about/, /midpoint/install/kubernetes/advanced-examples/, /midpoint/install/kubernetes/cluster/, /midpoint/install/kubernetes/, /midpoint/install/kubernetes/single-node/
