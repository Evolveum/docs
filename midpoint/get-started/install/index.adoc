...
:page-moved-from: /midpoint/install/
...
:page-description: This section describes how to install midPoint.

{% for v in site.data.midpoint-versions %}{% if v.status == null or v.status == "released" %}{% assign lastReleased = v %}{% endif %}{% endfor %}

This section describes how to install midPoint.

If this is your first time installing midPoint, see xref:/midpoint/get-started/quick-start/[].
...
[TIP]
====
The quickest way to deploy midPoint is to use the xref:/midpoint/get-started/quick-start/[midpoint-quickstart script] setup which is based on containers.
...
* xref:/midpoint/reference/[Configuration Reference]
