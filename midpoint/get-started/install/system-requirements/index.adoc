...
:page-moved-from: /midpoint/install/system-requirements/
...
This is default for xref:/midpoint/get-started/install/#containerized[containerized installation].
...
// Java prerequisites section
include::../bare-installation/java-requirements.adoc[]
...
Depending on xref:/midpoint/get-started/install/#installation-options[how you installed midPoint], you may choose to share the database with other systems or dedicate it to midPoint.
...
In the center of the schema, the largest rectangle represents a virtual machine, usually running Linux, with the xref:/midpoint/get-started/install/bare-installation/distribution/#java-requirements[basic required set of tools] installed.
MidPoint runs on this virtual machine.
It may also be a xref:/midpoint/get-started/install/containers/[Docker container with a midPoint image].
...
If you deploy in containers, see xref:/midpoint/get-started/install/containers/#deployment-schema[] for details.
