...
If you're on Linux or macOS, follow xref:/midpoint/get-started/quick-start/index.adoc[Quick Start Guide].
...
See the xref:/midpoint/get-started/quick-start/index.adoc[] to learn more about docker commands. 
...
The xref:/midpoint/get-started/install/post-install-orientation.adoc[] can help you navigate further.
