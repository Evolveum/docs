...
*** Credentials have to be set up in the web UI of OpenProject, consult the link:https://www.openproject.org/docs/api/example/[official OpenProject documentation].
