...
More info on subject you will find xref:/midpoint/reference/roles-policies/assignment/assigning-vs-linking/[here].
...
More on midPoints Role Based Access Control you will find xref:/midpoint/reference/roles-policies/rbac/[here].
