...
:page-since: 4.6
:page-toc: top
:page-description: Guide for enabling repository-based search in assignment panels and using it.
:page-keywords: repository search, assignment search, full-text search, MQL, midPoint Query Language
...
It is necessary to use Advanced Search that uses xref:/midpoint/reference/concepts/query/midpoint-query-language/[midPoint Query Language (MQL)].
...
image::extension-search-axiom.webp[Extension search using MQL]
...
== Using midPoint query language (MQL)

It is possible to formulate advanced queries using midPoint Query Language (MQL).
...
NOTE: You can learn more about filters and dereferencing in xref:/midpoint/reference/concepts/query/midpoint-query-language[midPoint Query Documentation].
...
image::search-for-system-role-assignments.webp[Search for system role assignments]
