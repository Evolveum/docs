...
This document provides basic information and examples of advanced search using xref:/midpoint/reference/concepts/query/axiom-query-language/[midPoint query language] in midPoint GUI.
...
More detail information and description of the operators can be found at xref:/midpoint/reference/concepts/query/axiom-query-language/[midPoint Query Language] documentation.
