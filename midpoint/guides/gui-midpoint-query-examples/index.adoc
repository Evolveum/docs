...
:page-alias: { "parent" : "/midpoint/reference/concepts/query/midpoint-query-language", "title":"GUI search - EXAMPLES", "display-order" : 600}
:page-moved-from: /midpoint/guides/search-with-axiom-examples/
...
Note: For detail explanation of the query please check additional xref:/midpoint/reference/concepts/query/midpoint-query-language/basic-usage/[basic usage of midPoint Query Language] page.
...
- xref:/midpoint/reference/concepts/query/midpoint-query-language/errors/[Errors while using midPoint query] - Error messages with some tips and explanation
...
- xref:/midpoint/devel/axiom/concepts/[Axiom Concepts] - Developers documentation - detail concepts of midPoint Query Language (known as Axiom).