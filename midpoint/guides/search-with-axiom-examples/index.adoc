...
Objects are searched in specific view in GUI. If user needs to search all objects of specific type, he has to select the relevant view (All users, All roles, All applications).
...
|Find User with access to specific Application (indirect assignment)
|`roleMembershipRef/@/name = "SAP application"`
|

|Find User with access to specific Application (indirect assignment) - according to displayName
|`roleMembershipRef/@/displayName = "End user"`
|
...
TODO: For detail explanation of the query please check additional xref:/midpoint/reference/concepts/query/axiom-query-language/examples/[Example AXIOM queries] page.
...
- xref:/midpoint/reference/concepts/query/axiom-query-language/examples/[Example Axiom Queries] - Additional examples with deeper explanation.
