...
:page-nav-title: Trying Out the MidPilot Connector Generator
...
IMPORTANT: Preview, the midPilot connector generator and its components are still under development, some concepts may change. Note that you may encounter bugs.
...
* *LLM__OPENAI_API_BASE*: OpenAI-compatible endpoint (i.e. https://openrouter.ai/api/v1)
