= Upgrading PostgreSQL Database with Native PostgreSQL Repository to PostgreSQL 16
:since: 4.8
:page-moved-from: /midpoint/guides/updating-to-pg16/
...
Based on discussed complications, you need to perform export using `pg_restore` with following options:
