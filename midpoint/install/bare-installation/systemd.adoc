...
To generate the systemd service customized to your environment you can use feature of xref:/midpoint/install/bare-installation/midpoint-sh/#generate[midpoint.sh].
