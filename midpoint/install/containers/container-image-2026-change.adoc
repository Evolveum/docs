...
Images for midPoint 4.11.0 and newer are created to run as a non-root user `midpoint` with UID 1000.

Images for already existing supported branches (4.8, 4.9 and 4.10) will still use `root` to avoid additinal issues during updates.
