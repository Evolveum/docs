...
You can browse the available images and tags on the Docker hub repository at https://hub.docker.com/r/evolveum/midpoint/tags.
...
See xref:/midpoint/install/bare-installation/using-support-branch/[] for more details.
