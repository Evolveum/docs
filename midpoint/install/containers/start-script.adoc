...
* start script +
Start script link:https://github.com/Evolveum/midpoint-docker/blob/master/midpoint-docker.sh[midpoint-docker.sh] is available in the *midpoint-docker* git repository. +
...
TCP port used for redirec the communication. ( http://localhost:${midPoint_port}/midpoint/ )
