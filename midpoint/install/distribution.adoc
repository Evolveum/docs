...
Please see xref:/midpoint/reference/deployment/midpoint-home-directory/[MidPoint Home Directory] and wiki:Stand-Alone+Deployment[Stand-Alone Deployment] pages for details.
