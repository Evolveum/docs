...
Use for clustering.
For more information see xref:/midpoint/reference/deployment/clustering-ha/[Clustering / high availability setup]. These secrets are specific for clustering demo.
