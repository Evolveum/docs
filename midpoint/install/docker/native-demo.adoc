...
services:
  ...
  midpoint_data:
    ...
    command: bash -c "while [ ! -s /opt/db-pw/dbpassword -o -e /opt/db-pw/init_in_progress ] ; do echo \"Wating for the end of init process...\" ; sleep 1 ; done ; docker-entrypoint.sh postgres "
    user: "70:70"
    depends_on:
     - data_init
    environment:
