...
The most of the changes can be done using environment variables *MP_SET_** (it is transformed to -D JVM properties - for more information see xref:/midpoint/install/bare-installation/midpoint-sh/[Start script] docs page).
