...
[NOTE]
The full configuration is available in link:https://github.com/Evolveum/midpoint-kubernetes/blob/main/advanced-examples/statefulset-pg-native_cm-sec.yaml[statefulset-pg-native_cm-sec.yaml] on github.
