...
This is realized by the *MP_SET_** values which are handled by the xref:/midpoint/install/bare-installation/midpoint-sh/[Start script].
...
For this purpose xref:/midpoint/install/bare-installation/midpoint-sh/[Start script] offer entry point feature.
