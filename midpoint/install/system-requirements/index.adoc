...
image::midpoint-environment-schema-basic.svg["Basic midPoint deployment schema with midPoint and its repository in the center and lines showing access routes to resources and user's workstation. Optional VPN is placed between midPoint and the work station"]
...
If your deployment is not public and you don't host it on your infrastructure, you need to secure the communication between end-user workstations and the midPoint instance.
...
image::midpoint-environment-schema-HA-two-nodes.svg["Two-node midPoint deployment schema with two midPoint node and their shared repository in the center and lines showing access routes to resources and user's workstation. Optional VPN and load balancer are placed between midPoint and the work station"]
