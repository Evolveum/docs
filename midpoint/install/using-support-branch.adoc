...
After new commit into the branch (new content) the jenkins automatically build the snapshot version and place the binary into the link:https://nexus.evolveum.com/[nexus.evolveum.com]. The binaries as available olson on link:https://download.evolveum.com/midpoint/[download] page.
