...
[NOTE]
====
The graphical user interface related to the work done in this module has changed significantly in midPoint 4.9.
This First steps methodology training has been built on midPoint 4.8 and so this module follows the steps needed for the configuration on the 4.8 version.
====
