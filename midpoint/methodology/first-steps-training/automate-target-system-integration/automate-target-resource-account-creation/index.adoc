...
Wait until the next run of the xref:/midpoint/methodology/first-steps-training/automate-target-system-integration/generate-usernames-in-midpoint/#automate-importing-users-to-midpoint[scheduled HRIS reconciliation task] finishes and check the results.
...
[.nowrap]#icon:arrow-right[] *xref:/midpoint/methodology/first-steps-training/automate-target-system-integration/automate-group-membership/[]*#