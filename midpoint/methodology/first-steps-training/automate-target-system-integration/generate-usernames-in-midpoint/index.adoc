...
:page-moved-from: /midpoint/methodology/first-steps-training/automate-target-system-integration/
...
It is a usual to start with the number iterator at _2_ to make the usernames more human friendly and intuitive: _abaker_, _abaker2_, _abaker3_, …
...
. In [.nowrap]#icon:circle[] *Mappings*#, click [.nowrap]#icon:plus[] btn:[New]# to create a new mapping.
    ** If you use the preconfigured Docker images for this guide, the username mapping is already there.
...
== Add new users to HRIS to test username generation
...
[.nowrap]#icon:arrow-right[] *xref:/midpoint/methodology/first-steps-training/automate-target-system-integration/automate-target-resource-account-creation/[]*#