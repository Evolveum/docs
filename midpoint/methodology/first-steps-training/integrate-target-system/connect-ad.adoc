...
Since we follow here the original xref:/midpoint/methodology/first-steps-training/connect-source-system/#playground-data-used-in-this-guide[MID-301 training course] footsteps, you will create the Active Directory resource from a preconfigured template.
...
[.nowrap]#icon:arrow-right[] *xref:/midpoint/methodology/first-steps-training/integrate-target-system/define-rules-for-data-handling/[]*#