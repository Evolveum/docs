...
In xref:/midpoint/methodology/first-steps-training/integrate-target-system/define-rules-for-data-handling/#define-synchronization-rules[], you have created an AD synchronization rule called _delete-unmatched-resource-object_ to delete unmatched accounts.
...
. Use the _Reconcile AD - development simulation_ reconciliation task you have set up and used in xref:/midpoint/methodology/first-steps-training/integrate-target-system/reconcile-ad-accounts/[].
...
. Run the _Reconcile AD - real production_ reconciliation task you have set up and used in xref:/midpoint/methodology/first-steps-training/integrate-target-system/reconcile-ad-accounts/[].
...
[.nowrap]#icon:arrow-right[] *xref:/midpoint/methodology/first-steps-training/enable-target-system-provisioning/[]*#