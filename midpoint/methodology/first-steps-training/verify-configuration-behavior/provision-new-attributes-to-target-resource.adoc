...
You have it ready for use from the earlier module: xref:/midpoint/methodology/first-steps-training/connect-source-system/import-accounts-from-hris/#simulate-a-single-account-import[].
...
[.nowrap]#icon:arrow-right[] *xref:/midpoint/methodology/first-steps-training/verify-configuration-behavior/update-existing-mapping/[]*#