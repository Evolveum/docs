...
You can now decommission all orphaned accounts (marked as undesired) in the target system using midPoint.
...
*TODO where this?* Another "Clean up" or join the previous Clean up steps and have this as substeps?

* *TODO accounts suffering data inconsistencies*: these need to kept (not deleted) and resolved (now or in future iterations)
