...
You should periodically review your xref:/midpoint/reference/mark/[marked accounts], especially those "temporary" states such as "To be decommissioned", "Do not update" and "Correlate later".
