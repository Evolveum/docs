...
* xref:/midpoint/reference/admin-gui/resource-wizard/#object-type-configuration[]
...
* xref:/midpoint/reference/admin-gui/resource-wizard/#wizard-for-task-creation[]
...
* xref:/midpoint/reference/admin-gui/resource-wizard/#how-to-use-lifecycle-state[]
...
* xref:/midpoint/reference/admin-gui/resource-wizard/#synchronization[]
* xref:/midpoint/reference/admin-gui/resource-wizard/#correlation[]
* xref:/midpoint/reference/admin-gui/resource-wizard/#mappings[]
