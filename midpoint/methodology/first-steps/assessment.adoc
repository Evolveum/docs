...
TIP: You can see this step in action in https://youtu.be/suo775ym_PE?t=1480&si=eI7fG5Fe2t4JQpey[Step 3: Import Source Data in the First Steps Methodology webinar] video.
