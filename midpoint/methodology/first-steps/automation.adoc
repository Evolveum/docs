...
TIP: You can see this step in action in https://youtu.be/suo775ym_PE?t=3626&si=vCRfLc_mHgJiIvNL[Step 8: Automate Integration in the First Steps Methodology Webinar] video.
