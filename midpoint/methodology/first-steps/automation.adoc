...
TIP: You can see this step in action in https://www.youtube.com/watch?v=suo775ym_PE&t=3626s[Step 8: Automate Integration in the First Steps Methodology Webinar] video.
