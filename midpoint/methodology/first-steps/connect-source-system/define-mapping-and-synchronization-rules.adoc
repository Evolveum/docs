...
[NOTE]
====
The resource-side attribute names (ie., Source) match those used in the xref:/midpoint/methodology/first-steps/connect-source-system/#playground-data-used-in-this-guide[MID-301 course training data].
...
[.nowrap]#icon:arrow-right[] *xref:/midpoint/methodology/first-steps/connect-source-system/import-accounts-from-hris/[]*#