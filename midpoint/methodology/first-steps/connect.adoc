...
In theory, you should give the data in your _source_ HR system absolute authority and use it to fix any inconsistencies in other _target_ systems, such as an Active Directory or other LDAP resources.
...
Then, xref:/midpoint/gui-guides/tasks/import-tasks/[create another import task] like you did for the simulation.
