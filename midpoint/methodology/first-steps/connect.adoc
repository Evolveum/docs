...
The actual numbers may, of course, differ based on what your systems contain, among other things.
...
This is useful if you are not sure about the exact purpose of some service accounts, for example, or need to do some further investigation as to why they can't be correlated.
...
* In case of accounts you're not sure about, mark them as _Do not touch_ so that they don't get deleted and you can investigate and decide their fate later.
* If you discover LDAP accounts that should not be there at all, like legacy or obviously malicious accounts, don't mark them at all.
