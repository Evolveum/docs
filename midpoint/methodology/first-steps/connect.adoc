...
*Use the xref:/midpoint/gui-guides/resources/create-resource/[guide on connecting a resource to midPoint] to help you with the configuration.*
...
| `givenName`
| Active
| We'll construct a full name from first and last anmes.
