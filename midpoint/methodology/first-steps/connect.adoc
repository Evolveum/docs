...
. In your LDAP target resource, create a icon:xchange-alt[] btn:[Reconciliation Task].
. Switch on the simulation to first preview the changes and prevent any harm to your data.
