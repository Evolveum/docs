...
Inspect the results and once you confirm the simulation yields expected results, run the real production reconciliation task which you used to reconcile the LDAP accounts previously.
...
* Privision LDAP accounts for new employees imported from HR.
