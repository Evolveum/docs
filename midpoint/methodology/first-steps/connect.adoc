...
Then, xref:/midpoint/guides/tasks/import-tasks/[create another import task] like you did for the simulation.
...
// TODO: I want  to link an existing correlation rules setup guide here.
...
[NOTE]
====
The attributes used in the correlation rules are acquired by the inbound mappings that are used for correlation only.
====
