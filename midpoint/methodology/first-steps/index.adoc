= First steps with midPoint: Methodology
:page-nav-title: First steps: Methodology
:page-toc: top
:page-display-order: 100
:experimental:
:page-moved-from: /midpoint/methodology/first-steps/audience/

This is a methodology of a simplified midPoint deployment
to help you grasp the basics and get tangible results in days instead of months.

This methodology is a blueprint to the initial identity management deployment modelling a common organization.
Its scope is limited to identities and their accounts with the ability to cover birthright permissions in target systems.

The articles in this methodology and xref:/midpoint/methodology/first-steps-training/[accompanying First steps training] include the following key points of deploying midPoint:
...
== For whom is this methodology?

This methodology is meant to help small and mid-size organizations.
...
Nonetheless, most concepts in this methodology and training are applicable to organizations of any size and type.
...
By going through the first steps methodology and training, you'll learn how to deploy midPoint iteratively and get first results in a matter of weeks, even if you face all the challenges mentioned above.
...
Proceed to the outline to discover what steps await you in your IGA deployment.
