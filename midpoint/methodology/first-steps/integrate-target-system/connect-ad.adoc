...
Since we follow here the original xref:/midpoint/methodology/first-steps/connect-source-system/#playground-data-used-in-this-guide[MID-301 training course] footsteps, you will create the resource from a preconfigured template.
