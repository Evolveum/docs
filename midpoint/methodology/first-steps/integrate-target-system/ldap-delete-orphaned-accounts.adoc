...
. Use the _Reconcile AD - development simulation_ reconciliation task you have set up and used in xref:/midpoint/methodology/first-steps/integrate-target-system/reconcile-ldap-accounts/[].
...
. Run the _Reconcile AD - real production_ reconciliation task you have set up and used in xref:/midpoint/methodology/first-steps/integrate-target-system/reconcile-ldap-accounts/[].
