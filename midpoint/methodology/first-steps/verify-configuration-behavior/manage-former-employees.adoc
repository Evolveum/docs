...
In this guide, long-term leave stands for cases such as parental leave.
...
* In the user's profile, go to [.nowrap]#icon:male[] *Projections*#, select the LDAP projection, and check that the *Administrative status* is set to _Disabled_.
