...
=== Verify the delayed delete trigger

Once the trigger is in place, you can go to the user's profile in midPoint, click *Projections*, select the LDAP resource, and see the timer when you hover your mouse over the account icon.

If you are on the Docker images prepared for this guide, you can check accounts with triggers on the *AD account notices* dashboard:
...
After the grace period elapses, check ... TBC