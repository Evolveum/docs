...
. In the HRIS resource, run the _HR Reconciliation - development simulation_ task xref:/midpoint/methodology/first-steps/automate-target-system-integration/automate-group-membership/#verify-your-configuration[you have used in the group membership automation module].
...
[.nowrap]#icon:arrow-right[] *xref:/midpoint/methodology/first-steps/override-incorrect-source-data/[]*#