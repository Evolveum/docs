...
* xref:/reference/admin-gui/resource-wizard/#policies[]
...
.Please refer to the following documentation:
* xref:/midpoint/reference/admin-gui/resource-wizard/#association-type-configuration[]
...
.Please refer to the following documentation:
* xref:/midpoint/reference/admin-gui/resource-wizard/#policies[]
