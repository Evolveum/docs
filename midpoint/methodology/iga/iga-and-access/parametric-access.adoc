...
The implementation of concept in midPoint is described in xref:./access-modeling/index.adoc#_access_to_application_resource_direct[Access to application resource] example 2 and 3 in access modeling.
