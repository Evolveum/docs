...
See also link:../identity-metadata-in-a-nutshell/[Identity Metadata in a Nutshell] for introduction to identity metadata and metadata implementation in midPoint.
...
Therefore we have decided to create link:../axiom/spec/[Axiom] - a new data modeling language.
It is based on link:../axiom/design-notes/[requirements and design principles] that we have laid out.
...
* link:../axiom/design-notes/[Axiom Design Notes]: Requirements and design principles of Axiom.
...
Further development of user interface went through several iterations, mostly due to the changes in metadata schemas caused by link:../metadata-multiplicity-problem/[metadata multiplicity problem].
Final user interface is suitable for system administrators.
However, link:../future-work/[more work] is needed to make it suitable for ordinary users.
