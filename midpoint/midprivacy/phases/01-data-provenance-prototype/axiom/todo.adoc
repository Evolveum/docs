...
** Final list of primitive data types (`axiom-types.axiom`)
...
* How to implement dynamic model: shadow attributes, resource connector configuration: "dynamic" data type
