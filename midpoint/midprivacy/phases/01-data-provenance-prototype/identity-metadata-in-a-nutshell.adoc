...
TODO: intro about purpose of this document
TODO: mention midPrivacy
...
TODO: Data model extensibility was always a crucial feature for midPoint deployments.
TODO: extensibility with custom metadata

TODO: Examples of custom metadata
...
TODO: Step 1: combine XSD with Axiom, switch to pure Axiom later when Axiom matures
