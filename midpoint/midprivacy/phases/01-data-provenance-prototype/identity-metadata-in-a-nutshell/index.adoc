...
Therefore it is quite easy to display metadata in midPoint user interface, as it is demonstrated by a following prototype:

image::screenshot-m1-transformation-metadata.png[Metadata screenshot]
