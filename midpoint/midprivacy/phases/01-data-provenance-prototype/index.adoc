...
** link:axiom/[Axiom Language Draft (composite document)]
** link:axiom/terminology/[Terminology]
** link:axiom/design-principles/[Design Principles]
** link:axiom/overview/[Overview]
** link:axiom/syntax/[Syntax]
** link:axiom/concepts/[Concepts]
** link:axiom/namespaces/[Namespaces]
** link:axiom/metadata/[Metadata] and link:axiom/metadata-midpoint-examples/[Metadata MidPoint Examples]
** link:axiom/cross-model-usecases/[Cross-Model Use Cases]
** link:axiom/design-notes/[Design Notes]
** link:axiom/implementation-notes/[Implementation Notes]
* Metadata Processing
...
* link:challenges/[Challenges, Open Questions and TODOs]
