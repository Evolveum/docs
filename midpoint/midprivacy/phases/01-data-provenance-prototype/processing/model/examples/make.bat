...
dot -Tpng example-filtering-by-loa.dot -o example-filtering-by-loa.png
dot -Tpng example-primary-email-selection.dot -o example-primary-email-selection.png
dot -Tpng example-origin-tracing.dot -o example-origin-tracing.png
dot -Tpng example-legal-base.dot -o example-legal-base.png
