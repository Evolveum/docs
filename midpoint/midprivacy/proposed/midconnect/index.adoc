...
E.g. SAML protocol makes the data available only during (interactive) authentification flow.
...
TODO: existing midPoint admin-gui too complicated
...
TODO: Part I, Part II, milestones
