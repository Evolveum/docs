...
assignment matches (relationship="manager" matches targetRef/targetOid="eb33bf4e-b093-42ff-9400-6f87c1b9ab2b") <4>
...
[source]
----
InOrgFilter: "inOrg" ( ValueSpecification | "Root" );
----
...
[source]
----
. type UserType and linkRef not exits
