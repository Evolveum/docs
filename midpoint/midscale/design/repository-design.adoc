...
** We need dynamic columns for extensions - this is generally impossible with JPA/ORM solutions.
...
* FK problem against parent table?
Possible solution - common `m_object_oid` table.
