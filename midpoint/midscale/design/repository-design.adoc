...
TODO: Can an inherited table be split/partitioned by resource and/or object class?
...
Check limitations about constraints for partitioned tables.
*** Unique "constraint" across table hierarchy is solvable by triggers, http://blog.ioguix.net/postgresql/2015/02/05/Partitionning-and-constraints-part-1.html[example here].
