...
* xref:/midpoint/reference/certification/notifications/[Access Certification Notifications]
** Mentioned as a possible timed action in xref:/midpoint/reference/certification/certification-campaign-configuration/escalation/[Escalation in Certification Campaigns]
