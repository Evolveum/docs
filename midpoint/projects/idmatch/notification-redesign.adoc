...
<systemConfiguration>
    ...
    <notificationConfiguration> <!-- this is Container, but order of handlers inside does not matter -->
        ...
        <handler> <!-- EventHandlerType, TODO currently not containerable, do we want Containerable for GUI? -->
            ...
            <!--
            TODO Unrealistic example of forked and chained elements (hardly used together).
             This shows that each notifier is inside the separate forked/chained element.
            -->
            <forked> <!-- EventHandlerType -->
                <passwordResetNotifier></passwordResetNotifier>
            </forked>
            <forked>
                <userPasswordNotifier></userPasswordNotifier>
            </forked>
            <!-- TODO: In container we will need explicit <order> element. -->
            ...
            so it seems like chained, but AbstractGeneralNotifier#processEvent returns true (for common notifiers like those below). -->
            ...
            <userPasswordNotifier>
                <!-- What does this mean? Should not we disallow nesting? -->
                <passwordResetNotifier></passwordResetNotifier>
            </userPasswordNotifier>
        </handler>
        <!-- Probably a bug - delete also sends the notification: -->
        <handler>
            <description>filter on handler directly works fine</description>
            <chained>
                <operation>add</operation>
                <simpleUserNotifier>
                    <recipientExpression>
                        <value>first@evolveum.com</value>
                    </recipientExpression>
            ...
            <chained>
                <simpleUserNotifier>
                    ...
                    <recipientExpression>
                        <value>second@evolveum.com</value>
                    </recipientExpression>
                    <transport>mail</transport>
                </simpleUserNotifier>
            </chained>
        ...
        <handler>
            ...
            <simpleUserNotifier>
                ...
                <!-- This implies <transport>bar</transport> -->
                <transportConfig>
                    <name>bar</name>
        ...
        <handler>
            ...
            <simpleWorkflowNotifier>
                ...
                <!-- Is there a good default for this? Can this return UserType as well? -->
                <recipientExpression>
                    <script>
                        <code>requestee</code>
                    </script>
                ...
                <!-- Probably overkill, just return the address directly in recipientExpression.
                Here the recipient is the requestee from above. Confusing?
