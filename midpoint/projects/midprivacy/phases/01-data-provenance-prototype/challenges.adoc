...
The metadata multiplicity, the link:../provenance-origin-basis/[concept of _yields_] and its relation to data protection is perhaps the most surprising discoveries in this project.
