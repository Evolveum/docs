...
TIP: See link:/midpoint/devel/design/design-meeting/[Design meeting guidelines] for tips how to lead the meeting.
...
link:../repository-design/[Meeting notes], link:../query-language/[Query language notes]
...
* MidPoint 5 vision. Lead: Rado. link:/midpoint/devel/design/midpoint-5-vision/[Design notes]
