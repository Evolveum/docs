...
We have utilized the results of xref:/midpoint/midprivacy/phases/01-data-provenance-prototype/[midPrivacy initiative] in this project, especially the xref:/midpoint/axiom/[Axiom] modeling language.
