...
After succesfully running this command PowerShell should display something like this:
...
Here is a table of useful commands to control the Docker environment.
After running this command, the PowerShell will print something similar to this:
...
The xref:../install/post-install-orientation.adoc[] can help you navigate further.
...
Select this container and see the details. 
