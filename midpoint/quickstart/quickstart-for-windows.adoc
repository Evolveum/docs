...
This guide is here to help you get started and deploy midPoint on your local computer with Microsoft Windows operating system using Docker Desktop and PowerShell. 
