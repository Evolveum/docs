...
* xref:/midpoint/reference/expressions/expressions/script/javascript/[ECMAScript (JavaScript) expressions]

* Protected accounts

* Basic Segregation of Duties (SoD): xref:/midpoint/reference/roles-policies/segregation-of-duties/[Role exclusions]
