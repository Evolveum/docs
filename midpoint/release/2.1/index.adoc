...
:page-release-version: 2.1
:page-wiki-name: Release 2.1
:page-liquid:

Release {page-release-version} is a sixth midPoint release code-named _Coeus_.
The {page-release-version} release brings new features, better stability and robustness.
