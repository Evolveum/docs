...
:page-release-version: 2.2
:page-wiki-name: Release 2.2
:page-liquid:

Release {page-release-version} is an eighth midPoint release code-named _Crius_.
The {page-release-version} release brings numerous new features and many improvements.
