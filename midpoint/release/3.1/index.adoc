...
:page-release-version: 3.1
:page-wiki-name: Release 3.1
:page-liquid:

Release {page-release-version} is an eleventh midPoint release code-named _Sinan_.
The {page-release-version} release brings new usability features and significantly improved user interface. It also improves performance, diagnostics and overall product quality.
