...
* MidPoint 3.2 switched to a completely new wiki:LDAP+Connector[LDAP Connector]. This connector is expected to resolve many xref:/connectors/connid/1.x/icf-issues/[issues] of the original Sun ICF framework that are still felt today.
