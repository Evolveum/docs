...
Release {page-release-version} is a thirteenth midPoint release code-named _Tycho_.
The {page-release-version} release brings new advanced LDAP connector, internal improvements and governance technology preview.
