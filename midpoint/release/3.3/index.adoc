...
:page-release-version: 3.3
:page-wiki-name: Release 3.3
:page-liquid:

Release {page-release-version} is a fourteenth midPoint release code-named _Lincoln_.
The {page-release-version} release brings major GUI look & feel improvements and miscellaneous new features that improve practical usability of midPoint.
