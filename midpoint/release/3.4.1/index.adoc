...
:page-release-version: 3.4.1
:page-wiki-name: Release 3.4.1
:page-liquid:

Release {page-release-version} is a seventeenth midPoint release.
It is a first maintenance update for 3.4.x version family code-named _Heisenberg_.
The {page-release-version} release brings identity governance features and significant user interface improvements. This maintenance update brings a number of fixes and minor improvements.
