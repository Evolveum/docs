...
Release {page-release-version} is a sixteenth midPoint release code-named _Heisenberg_.
The {page-release-version} release brings identity governance features and significant user interface improvements.
