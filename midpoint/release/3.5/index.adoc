...
:page-release-version: 3.5
:page-wiki-name: Release 3.5
:page-liquid:

Release {page-release-version} is an eighteenth midPoint release code-named _Einstein_.
The {page-release-version} release brings lots of features related to identity governance, self-registration and support for JSON/YAML.
