...
:page-wiki-name: Installing midPoint from Binary Distribution v3.6.1
:page-wiki-id: 24675615
:page-wiki-metadata-create-user: semancik
:page-wiki-metadata-create-date: 2017-10-09T15:47:54.250+02:00
:page-wiki-metadata-modify-user: semancik
:page-wiki-metadata-modify-date: 2017-10-09T15:47:54.250+02:00
:page-liquid:
...
.Release Notes
====
Please make sure to see xref:/midpoint/release/3.6/[Release Notes] for list of environments that are known to work and for the list of known issues in current release.
...
For a quick introduction to use of midPoint please follow the instructions on xref:/midpoint/get-started/quick-start/[First Steps] page.
Full xref:/midpoint/guides/admin-gui-user-guide/[Administration Interface] is also available.


== See Also

* xref:/midpoint/get-started/quick-start/[First Steps]
