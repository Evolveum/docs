...
Release {page-release-version} is a twenty-third midPoint release code-named _Darwin_.
The {page-release-version} release brings new deployment model and numerous gradual improvements.
