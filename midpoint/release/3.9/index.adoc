...
Release {page-release-version} is a twenty-seventh midPoint release code-named _Galileo_.
The {page-release-version} release brings broad assortment of improvements and new features in almost all areas of midPoint functionality.
