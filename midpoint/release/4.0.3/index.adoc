...
** Improved wiki:Prism+Objects[Prism] API and code structure
...
The only effect of this change is the change in wiki:Code+Contribution+Guidelines[code contribution] process that requires signing of CLA.
