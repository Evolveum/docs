...
Release {page-release-version} is a thirty-fourth midPoint release.
It is the third maintenance update for 4.0.x version family code-named _Gutenberg_.
The 4.0.x is a xref:/midpoint/support/long-term-support/[long-term support (LTS)] version family.
