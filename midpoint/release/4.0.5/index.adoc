...
It is the fifth maintenance update for 4.0.x version family code-named _Gutenberg_.
The 4.0.x is a xref:/support/long-term-support/[long-term support (LTS)] version family.
The {release-version} release brings minor dependency upgrades related to potential vulnerabilities.
...
== Dependency Updates From Version 4.0.4

* Spring Boot was updated to 2.1.18.RELEASE
** This brings Spring Framework version to 5.1.19.RELEASE
** On top of that, Tomcat 9.x was further updated to 9.0.64
* Apache XML Security for Java (org.apache.santuario:xmlsec) used by CXF was updated to 2.1.8
* Logback was updated to 1.2.11
...
** Numerous security fixes from the EU-FOSSA bug bounty (see xref:/midpoint/reference/security/advisories/[Security Advisories])
...
* The xref:/midpoint/reference/legacy/jaspersoft-studio/[integration of Jaspersoft Studio for midPoint (a.k.a. "Jasper plugin")] will not work with midPoint 4.0. The reporting web service was changed and the plugin was not yet adapted to that change.
...
Access to report web service requires this authorization as well (e.g. needed for access by xref:/midpoint/reference/legacy/jaspersoft-studio/[Jaspersoft Studio]).
