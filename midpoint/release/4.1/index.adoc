...
Release {page-release-version} is a thirty-second midPoint release code-named _Pasteur_.
The {page-release-version} release brings major authentication improvements, user interface improvements, improved archetype functionality and a number of smaller improvements.
