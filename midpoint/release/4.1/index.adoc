...
* SOAP-based xref:/midpoint/reference/before-4.8/legacy/soap/[IDM Model Web Service Interface] is deprecated, and it will be removed in midPoint 4.2. Please use xref:/midpoint/reference/interfaces/rest/[RESTful interface] instead.
