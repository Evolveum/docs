...
Release {page-release-version} is a thirty-third midPoint release code-named _Maxwell_.
The {page-release-version} release brings new reporting mechanism, updates to auditing implementation, continued improvement for authentication and handful of other interesting improvements.
Most importantly, midPoint {page-release-version} brings experimental updates to the very foundations of midPoint.
...
There were numerour changes to initial objects in this release.
