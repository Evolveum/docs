...
** xref:/midpoint/midprivacy/phases/01-data-provenance-prototype/[MidPrivacy: Data provenance prototype] (experimental)
...
** xref:/midpoint/midprivacy/phases/01-data-provenance-prototype/axiom/spec/[Axiom data modeling language] (experimental)
...
* xref:/midpoint/studio/[MidPoint Studio] plugin for IntelliJ IDEA will be released in beta quality around the same time as midPoint 4.2 release.
...
* Functionality developed in scope of xref:/midpoint/midprivacy/phases/01-data-provenance-prototype/[midPrivacy data provenance prototype] is part of this release.
...
* Mapping processing was improved and cleanup, mostly as a side effect of xref:/midpoint/midprivacy/phases/01-data-provenance-prototype/[midPrivacy: Data Provenance Prototype]
...
Most changes were related to the xref:/midpoint/midprivacy/[midPrivacy] effort and Axiom prototype.
