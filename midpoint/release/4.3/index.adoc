...
* Docker images will be released shortly after midPoint release.

* Overlay projects and other associated artifacts will be released soon after midPoint 4.3 release.

* link:/midpoint/studio/[MidPoint Studio] version 4.3 will be released soon after midPoint 4.3 release.
