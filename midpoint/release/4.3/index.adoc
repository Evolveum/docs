...
Release {page-release-version} is a thirty-fourth midPoint release code-named _Faraday_. The {page-release-version} release brings ... TODO
...
** Early prototype of scalable repository implmenetation based on PostgreSQL (experimental)
...
MidPoint {page-release-version} data model is not completely backwards compatible with previous midPoint versions.
...
* There were changes in internal code structure, most notably changes in ..TODO...
