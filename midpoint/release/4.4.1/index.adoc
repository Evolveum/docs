...
Release {release-version} is a thirty-ninth midPoint release. It is the first maintenance update for 4.4.x version family code-named _Tesla_.
The {release-version} release brings improvements for migration to native PostgreSQL repository and miscellaneous bugfixes and minor improvements.
...
* Docker images will be release in Docker Hub shortly after the release.
// https://hub.docker.com/layers/evolveum/midpoint/4.4/images/sha256-015e67f440c44e2cf10a01cef0c324f43e9fbaae64fb0fa09c5696957533825c?context=explore[4.4.1] and https://hub.docker.com/layers/evolveum/midpoint/4.4-alpine/images/sha256-60ffb2db37860dd09c66cafcb88e86ab1e8aa2c096aacaa18450d5098b3a8922?context=explore[4.4.1-alpine].
