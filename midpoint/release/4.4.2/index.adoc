...
* TODO: Docker images were released in Docker Hub: hhttps://hub.docker.com/layers/evolveum/midpoint/4.4.1/images/sha256-58186b777c32a1a9b30afb205d91ae270b57088258962989577e7ad88521da83?context=explore[4.4.1] and https://hub.docker.com/layers/evolveum/midpoint/4.4.1-alpine/images/sha256-d5ddef1ac24a9007333faef93ac1d4e1c4071a391e8131e1348c0f67833b4077?context=explore[4.4.1-alpine].
...
* Re-import of initial files: `\*-archetype-task-*.xml`, `560-task-validity.xml`, and `570-task-trigger.xml`.
