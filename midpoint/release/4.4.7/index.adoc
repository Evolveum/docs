...
TODO The {release-version} release brings security and miscellaneous bugfixes.
...
To see full list of fixes see link:https://jira.evolveum.com/browse/MID-9429?jql=project%20%3D%20MID%20AND%20status%20in%20(Resolved%2C%20Closed)%20AND%20fixVersion%20%3D%204.4.7[Evolveum Jira]
