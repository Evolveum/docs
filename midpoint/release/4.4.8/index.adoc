...
See xref:_behavior_changes_since_4_4_7[] and bug:MID-9460[].

** Introduced fine-grained authorizations that grant access at the level of a single REST operation.
See xref:/midpoint/reference/before-4.8/security/authorization/service/[].
...
* Please check if there is a need to add authorizations to specific users due to xref:_behavior_changes_since_4_4_7[].
