...
See link:#_behavior_changes_since_4_4_7[behavior changes since 4.4.7] and bug:MID-9460[] and xref:/midpoint/security/advisories/023-unauthorized-operation-execution/[Security Advisory 23].
