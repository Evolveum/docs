...
* Docker images were released in Docker Hub: https://hub.docker.com/layers/evolveum/midpoint/4.4/images/sha256-015e67f440c44e2cf10a01cef0c324f43e9fbaae64fb0fa09c5696957533825c?context=explore[4.4].
//and https://hub.docker.com/layers/evolveum/midpoint/4.3-alpine/images/sha256-cd92e0f2becf1538d8e463fe8018107bf03b6e5ebbebcf1238c2856a42e4db8d?context=explore[4.3-alpine].
...
* `\*-task-*-.xml` (all task definitions): Migrated from legacy to the new (activity-based) configuration. Updated task archetypes, migrated to _activities_ configuration, removing deprecated items. Adjustements for task details page.
