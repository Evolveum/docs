...
** Axiom query language (integration, documentation)
...
TODO: Short overview of new repo and scalability improvements.
...
* TODO: SAML configuration changes - incompatible

* TODO Removal of deprecated schema items, planned for removal in 4.4 (see below)
...
* TODO: Schrodinger: separated, significantly improved.
...
TODO: https://docs.evolveum.com/midpoint/reference/upgrade/upgrade-guide/

* TODO Jasper-based reports to native reports:
Use of Jasper-based reports in midPoint is deprecated since midPoint 4.2 in favor of the new "native" reports.
See xref:/midpoint/reference/misc/reports/rewrite-jasper-to-object-collection-report/[] for details.
