...
Release {release-version} is a thirty-seventh midPoint release code-named _Tesla_.
The {release-version} release brings major performance and scalability improvements implemented in scope of xref:/midpoint/projects/midscale/[midScale project].
...
Changes in the connector include UUID data type support and the addition of SQLstate code based error handling options.
