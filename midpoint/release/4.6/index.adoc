...
* Shopping cart and role catalog fully replaced with new request access wizard
+
_Actions required:_
...
* `userDashboardLink` and `userDashboard` are deprecated.
...
The same merging mechanism as for other GUI parts apply.
...
- Shadow classification and tag generation functionality now resides in the `provisioning-impl` module (link:https://github.com/Evolveum/midpoint/commit/7296dd15[7296dd15]).
