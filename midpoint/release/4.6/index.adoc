...
** Request access...
* Smart-correlation...
* Query API improvements (new filters)
* Assignment panels using repository
...
This includes xref:/midpoint/reference/interfaces/midpoint-client-java/[Java client library], various https://github.com/Evolveum/midpoint-samples[samples], scripts, connectors and other non-bundled items.
...
// TODO === Behavior Changes Since 4.5
