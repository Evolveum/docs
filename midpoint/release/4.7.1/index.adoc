...
Release {release-version} is a forty-seventh midPoint release.
It is the first maintenance update for 4.7.x version family code-named _Baumgarten_.
The {release-version} release brings security and miscleanous bugfixes.
