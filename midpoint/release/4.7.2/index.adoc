...
It is the second maintenance update for 4.7.x version family code-named _Baumgarten_.
The {release-version} release brings TODO security and miscleanous bugfixes.
