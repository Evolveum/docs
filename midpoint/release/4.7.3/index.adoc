...
To see full list of fixes see link:https://jira.evolveum.com/issues/?jql=project%20%3D%20MID%20AND%20status%20in%20(Resolved%2C%20Closed)%20AND%20fixVersion%20%3D%204.7.3[Evolveum Jira]
