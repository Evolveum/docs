...
See xref:_behavior_changes_since_4_7_3[] and bug:MID-9460[].
...
Please check if there is a need to add authorizations to specific users due to xref:_behavior_changes_since_4_7_3[].
