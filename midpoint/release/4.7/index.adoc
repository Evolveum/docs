...
More details may be provided along with individual changes below.
...
** Added user details panel `roleMemberships` for applications.

+
_Action suggested:_ Add it to your configuration.

** Resource wizard panel `rw-connectorConfiguration-partial` for LDAP and AD connectors was updated: `bindDn` and `bindPassword` properties are made visible.
