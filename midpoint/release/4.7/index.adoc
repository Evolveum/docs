...
* Simplification of application and business role creation using the role wizard. The business role wizard contains simple configuration steps for creating a role, assigning application roles and assigning members.
The wizard for application roles contains similar steps, a step for creating a role, steps for assigning an application and a step for assigning members. xref:/midpoint/reference/admin-gui/admin-gui-config/#wizard-panels[Wizard panel configuration]
