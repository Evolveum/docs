...
* Various fixes in Self Service - Credentials - removed trimming of whitespaces in passwords, Fixed incorrect forced password change on all resources. 
...
To see full list of fixes see link:https://jira.evolveum.com/projects/MID/versions/13405[Evolveum Jira]
