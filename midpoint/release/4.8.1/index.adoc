...
:page-liquid:
:page-toc: top
:jira: https://jira.evolveum.com/browse/

Release {release-version} is a fifty-third midPoint release, code-named _Curie_.
...
Please contact our link:https://evolveum.com/partners/find-a-partner/[official partners] or link:mailto:sales@evolveum.com[Evolveum sales] to inquire about your subscription options.
...
To see full list of fixes see link:https://jira.evolveum.com/issues/?jql=project%20%3D%20MID%20AND%20status%20in%20(Resolved%2C%20Closed)%20AND%20fixVersion%20%3D%204.8.1[Evolveum Jira]
