...
See link:#_behavior_changes_since_4_8_1[behavior changes since 4.8.1], bug:MID-9460[] and xref:/midpoint/security/advisories/023-unauthorized-operation-execution/[Security Advisory 23].
...
Please check if there is a need to add authorizations to specific users due to link:#_behavior_changes_since_4_8_1[behavior changes since 4.8.1].
