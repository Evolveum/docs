...
* Cleanup action now improved and configurable
** Now prints notifications about missing references, clear passwords, etc.
* Multiple annotations and intention actions
** Replace shadowRef association
** Replace clearValue/encryptedData in protected strings
* Better axiom query language support
