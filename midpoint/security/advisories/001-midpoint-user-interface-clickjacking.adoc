...
:page-moved-from: /midpoint/reference/security/advisories/001-midpoint-user-interface-clickjacking
...
MidPoint users are advised to upgrade their deployments to the latest builds from the xref:/midpoint/get-started/install/bare-installation/using-support-branch/[support branches]. MidPoint 3.6.x users are advised to upgrade to a newer midPoint version.
