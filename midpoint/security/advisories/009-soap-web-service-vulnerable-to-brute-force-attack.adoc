...
Users of affected MidPoint versions are advised to upgrade their deployments to the latest builds from the xref:/midpoint/get-started/install/bare-installation/using-support-branch/[support branches].
