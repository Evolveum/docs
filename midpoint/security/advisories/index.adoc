...
| 27
| xref:/midpoint/security/advisories/027-privilage-escalation-via-audit-log/[Privilege Escalation via Audit Log]
| 02 June 2026
| Critical
...
| 28
| xref:/midpoint/security/advisories/028-plain-text-password-hints/[Password Hints Stored in Plain Text]
| 09 September 2026
| Low
| Password hints were stored in the repository as plain text and could be read by anyone with access to the database, its backups or raw exports.
|===
