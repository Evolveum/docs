...
| 4.8 / 4.9 / 4.10
| False positive
| Midpoint doesn't use Tomcat's DIGEST authenticator.
|
|
...
| 4.8 / 4.9 / 4.10
| False positive
| Midpoint doesn't declare Tocmat container security constraints.
|
|
...
| 4.8 / 4.9 / 4.10
| False positive
| Midpoint uses login form through Spring Security's filter, not Tomcat's.
|
|
|===
