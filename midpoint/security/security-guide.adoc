...
See xref:/midpoint/reference/expressions/expressions/security/[Expression Security] and xref:/midpoint/reference/expressions/expressions/profiles/configuration/[Expression Profile Configuration] page for details.
