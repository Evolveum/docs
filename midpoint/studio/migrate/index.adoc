...
. keep *Download file pattern* as is unless you know what you are doing. See also <<../usage/index.adoc#updating-project-settings>> x link:/midpoint/studio/[Updating Project Settings]
