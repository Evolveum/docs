...
** *Download file pattern*: template for downloaded object file name. Default: `objects/$T/$n.xml`
** *Generated file pattern*: template for generated object file name. Default: `scratches/gen/$n.xml`
+
[cols="25%,75%", options="header"]
|===
^|Placeholder
