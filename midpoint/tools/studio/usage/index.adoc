...
Studio internally uses xref:/midpoint/tools/midscribe/index[midScribe] tool to generate the documentation.

.Generate documentation dialog
image::generate-documentation.png[Screenshot of generate documentation dialog]
...
The cleanup operation behavior can be configured in the project settings.

.Objects cleanup
image::objects-cleanup.png[Screenshot of objects cleanup settings]

#TODO#

.Missing objects
image::missing-objects.png[Screenshot of missing objects settings]
