...
Source code for such releases is split from the _master branch_ into a xref:/midpoint/install/bare-installation/using-support-branch/[_support branch_] at the point where a minor release is finished.
...
* xref:/midpoint/install/bare-installation/using-support-branch/[Using Support Branch]
