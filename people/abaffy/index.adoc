...
AI chess engine::
neural network governed Monte Carlo search; Cython, PyTorch, Reinforcement learing

AI Mario player::
Students` Professional Activities contest; Python, PyTorch, Stable Baselines, Reinforcement learing
