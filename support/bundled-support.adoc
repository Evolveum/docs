...
* xref:/midpoint/reference/before-4.8/legacy/eclipse-plugin/[MidPoint plugin for Eclipse IDE]

* xref:/midpoint/reference/before-4.8/legacy/jaspersoft-studio/[MidPoint-specific integration for Jaspersoft Studio]
