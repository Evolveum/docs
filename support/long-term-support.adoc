...
====
For the explanation of midPoint release process, versioning scheme and other technical details about midPoint releases please see the xref:../versioning/index.adoc[versioning page].
====
