...
See xref:../../midpoint/midscale/architecture/[MidScale archtecture relative].

See xref:../../midpoint/midscale/architecture/[] with automatic title.

See xref:../../midpoint/midscale/architecture/#repository[repository section in midScale architecture].
